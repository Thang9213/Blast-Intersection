...
public class Shooter : MonoBehaviour
{
    ...
    public int score;
    public bool canUpgrd;
    public int upgrdScore;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Q) && canUpgrd)
        {
            upgradeShooter();
        }
    }
    ...
    void updateScore()
    {
        ...
        if (score >= upgrdScore)
        {
            upgrdImg.gameObject.SetActive(true);
            canUpgrd = true;
        }
    }
    ...
    void upgradeShooter ()
    {
        upgrdImg.gameObject.SetActive(false);
        reloadTime = reloadTime/2;
        upgrdScore = upgrdScore * upgrdScore;
    }
}
